    ...
    <div class="card" id="userSettingsForm">
        ...
        >
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    <label for="enable_investments" class="col-form-label col-sm-3">
                        {{ __('Enable investments') }}
                    </label>
                    <div class="col-sm-9 d-flex align-items-center">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="enable_investments" v-model="form.enable_investments">
                            <label class="form-check-label ms-2" for="enable_investments">
                                {{ __('Show investment related features in the UI') }}
                            </label>
                        </div>
                        <HasError field="enable_investments" :form="form" />
                    </div>
                </div>
            </div>
        ...
        data: () => ({
            form: new Form({
                ...
                start_date: window.YAFFA.start_date,
                    ...
                    enable_investments: (window.YAFFA.enable_investments === undefined) ? true : window.YAFFA.enable_investments,
            }),
        }),
        mounted() {
            // Finally, initialize tooltips
                ...
                this.form.patch(
                    ...
                    .then(response => {
                        if (response.status === 200) {
                            ...
                            if (typeof response.data.data.enable_investments !== 'undefined') {
                                window.YAFFA.enable_investments = response.data.data.enable_investments;
                            }
>>>>>>> Stashed changes
